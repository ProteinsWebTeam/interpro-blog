...
In InterPro, SRGAP2A proteins are matched by both the SRGAP2 family (IPR030252) and the SRGAP1/2/3, SH3 domain (IPR035648) entries. However, SRGAP2B and SRGAP2C can only be found in the SRGAP2 family (IPR030252) entry (Figure 5). This may seem odd at first glance, but from the alignment, we can see the protein sequence similarity among SRGAP2A/B/C is at their N terminus (Figure 6). 
